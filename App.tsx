...
const App: React.FC = () => {
  ...
  // Settings State (managed directly in App.tsx as they are passed to multiple hooks/components)
        ...
        {!isNotepadFullscreen && (
          ...
          >
            <div className="flex flex-col flex-grow h-full"> 
              ...
              />
              {isLoading && (
                <div className="px-4 pb-2 text-xs text-gray-600 text-center bg-gray-100 border-t border-gray-300">
                  {isInternalDiscussionActive ? (
                    <>
                      <span>
