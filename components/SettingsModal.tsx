...
import { MIN_MANUAL_FIXED_TURNS, MAX_MANUAL_FIXED_TURNS } from '../constants';
import { X, Bot, MessagesSquare, SlidersHorizontal, Info, RotateCcw } from 'lucide-react';
              ...
              {discussionMode === DiscussionMode.FixedTurns && (
                <div className="flex items-center space-x-2 pl-7">
                  ...
                  <input 
                    ...
                    aria-label={`设置固定对话轮数, 最小 ${minManualFixedTurns}, 最大 ${maxManualFixedTurns}`}
                  />
                  <span className="text-sm text-gray-600">轮 (范围: {minManualFixedTurns}-{maxManualFixedTurns})</span>
                </div>
              )}
            </div>
          </section>
